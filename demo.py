...
commentaires = [
    ...
    "La directrice de l'école est Mme Brigitte.",
...
for t in nlp.documents:
    print(t.emoticon_doc)
exit()
# for s in nlp.subsentences:
# 	print(s.tokens)
...
# res = nlp.documents[0].replace_coreference(attribute='source', replace=['CLS'])
# for s in res:
# 	print(s)
# exit()
