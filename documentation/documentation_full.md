...
**NLP** (all data) => **Documents** => **Sentences** => **Subsentences** => **Tokens**
At each level direct access to inferior levels is possible i.e. ``nlp.sentences`` gives access to a list of all the **Sentences** in the current data, while ``nlp.documents[0].sentences`` gives only the **Sentences** of the first **Document**.

NLP is iterable and will yield Document class
